...
| implicit field projection from enum-typed values (`stage.height`) | exhaustive `match` that narrows to a concrete variant before field access | common field names are not structural evidence; match keeps shape changes visible |
